...
First, you need to have some soft of Software Defined Radio (SDR) installed on your system. There are many out there; (RTL-SDR)[https://www.rtl-sdr.com/rtl-sdr-blog-v-3-dongles-user-guide/], (HackRF-One)[https://greatscottgadgets.com/hackrf/], (AirSpy)[https://airspy.com/products/] just to name a few.
...
By right-clicking in on the FSK-signal in Inspectrum we can do a "Frequency Plot":
...
At this point, we no nothing of the internal packet layout, but we can start to identify patterns. 
